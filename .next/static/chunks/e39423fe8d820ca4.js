...
to {
  ...
  animation: ${H} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,J=({toast:e})=>{let{icon:t,type:a,iconTheme:r}=e;return void 0!==t?"string"==typeof t?i.createElement(Y,null,t):t:"blank"===a?null:i.createElement(M,null,i.createElement(B,{...r}),"loading"!==a&&i.createElement(_,null,"error"===a?i.createElement(z,{...r}):i.createElement(F,{...r})))},K=g("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
