                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                request.budget && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "flex items-center gap-1",
                                    children: [
...
"[project]/src/lib/firebase/request.service.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const createRequest = async (data)=>{
    try {
        ...
        await Promise.all([
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$notification$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createNotification"])(data.providerId, `📩 Nueva solicitud de ${data.clientName}`, `${data.clientName} ha enviado una solicitud para: ${category.name}${specialty ? ` (${specialty.name})` : ''}`, 'request', `/dashboard/requests/${docRef.id}`),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$notification$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createNotification"])(data.clientId, '✅ Solicitud enviada', `Tu solicitud para ${category.name} ha sido enviada a ${data.providerName}`, 'response', `/dashboard/requests/${docRef.id}`)
        ]);
        return docRef.id;
    } catch (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$request$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firebase/request.service.ts [app-ssr] (ecmascript)");
...
function RequestsPage() {
    ...
    const loadRequests = async ()=>{
        ...
        setLoading(true);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$request$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFilteredRequests"])(user.uid, currentRole || 'client', filters);
            setRequests(data);
        } catch (error) {
...
//# sourceMappingURL=_a2935c64._.js.map