module.exports = [
"[project]/src/lib/firebase/portfolio.service.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const createPortfolioItem = async (data)=>{
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["log"].info('📸 Item de portafolio creado:', docRef.id);
        return docRef.id;
    } catch (error) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["log"].error('❌ Error creando item de portafolio:', error);
...
const createPortfolioFromTestimonio = async (providerId, testimonio, requestData)=>{
    try {
        const dbInstance = getDb();
        const docRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(dbInstance, COLLECTION_NAME)); // ✅ COLLECTION_NAME definido arriba
        const now = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["serverTimestamp"])();
        const itemData = {
            providerId,
...
const getProviderPortfolio = async (providerId, options)=>{
    try {
        ...
        const constraints = [
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])('isPublished', '==', true),
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["limit"])(options?.limit || 20)
        ];
        if (options?.category) {
            constraints.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])('category', '==', options.category));
        }
        if (options?.lastDoc) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["log"].error('❌ Error obteniendo portafolio:', error);
        return {
            items: [],
            lastDoc: null
        };
...
const getPortfolioItem = async (itemId)=>{
    try {
        const dbInstance = getDb();
        const docRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(dbInstance, COLLECTION_NAME, itemId);
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["log"].error('❌ Error obteniendo item de portafolio:', error);
        return null;
    }
};
const updatePortfolioItem = async (itemId, data)=>{
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["log"].info('📸 Item de portafolio actualizado:', itemId);
    } catch (error) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["log"].error('❌ Error actualizando item de portafolio:', error);
...
const deletePortfolioItem = async (itemId)=>{
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["log"].info('📸 Item de portafolio eliminado:', itemId);
    } catch (error) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["log"].error('❌ Error eliminando item de portafolio:', error);
...
const likePortfolioItem = async (itemId)=>{
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["log"].error('❌ Error dando like:', error);
...
const getPortfolioStats = async (providerId)=>{
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["log"].error('❌ Error obteniendo estadísticas del portafolio:', error);
        return {
            totalItems: 0,
            totalViews: 0,
            totalLikes: 0,
...
"[project]/src/app/(dashboard)/dashboard/portfolio/new/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$portfolio$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firebase/portfolio.service.ts [app-ssr] (ecmascript)");
...
function NewPortfolioPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (imageUrls.length === 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('Agrega al menos una imagen');
            return;
        }
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$portfolio$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createPortfolioItem"])({
                providerId: user.uid,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success('✅ Trabajo agregado al portafolio');
            router.push('/dashboard/portfolio');
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('Error al agregar el trabajo');
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=_1adf2b8f._.js.map