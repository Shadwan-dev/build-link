...
function NewRequestPage() {
    ...
    const { currentRole, hasRole, isLoading: roleLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$RoleContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRole"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        if (!isClient) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('Solo los clientes pueden crear solicitudes');
            return;
        }
        setLoading(true);
        try {
            ...
            const requestId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$requests$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createRequest"])({
                clientId: user.uid,
                clientName: user.displayName || 'Usuario',
                clientEmail: user.email || '',
                clientPhone: user.phone || '',
...
//# sourceMappingURL=src_b0f7ec74._.js.map