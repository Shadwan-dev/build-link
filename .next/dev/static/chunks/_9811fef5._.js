...
function ProfilePage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setSaving(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$profile$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUserProfile"])(user.uid, formData, firebaseUser || undefined);
            await refreshUser();
    ...
    const handleRequestVerification = async ()=>{
        ...
        if (!formData.identification || !formData.specialties?.length || !formData.legalName) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Completa todos los campos requeridos (identificación, especialidades, razón social)');
            return;
        }
...
_s(ProfilePage, "8PE1q6xN038TZ8ILE8KbUy3xuIM=", false, function() {
    return [
...
//# sourceMappingURL=_9811fef5._.js.map