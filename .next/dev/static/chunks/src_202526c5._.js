...
function NewRequestPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NewRequestPage.useEffect": ()=>{
            const loadProviders = {
                "NewRequestPage.useEffect.loadProviders": async ()=>{
                    ...
                    try {
                        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$provider$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProvidersByRegion"])(formData.locationData.regionId, formData.locationData.provinceId || undefined);
            ...
            }["NewRequestPage.useEffect.loadProviders"];
            loadProviders();
        }
    }["NewRequestPage.useEffect"], [
        formData.locationData.regionId,
        formData.locationData.provinceId
    ]);
    // ✅ Validación por paso
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            const selectedProvidersData = availableProviders.filter((p)=>formData.providers.includes(p.uid));
            const providerId = selectedProvidersData.length > 0 ? selectedProvidersData[0].uid : 'general';
            const providerName = selectedProvidersData.length > 0 ? selectedProvidersData[0].displayName : 'Proveedor general';
            // ✅ Obtener especialidades de los proveedores seleccionados
            const allSpecialties = selectedProvidersData.flatMap((p)=>p.specialties).filter((s, i, arr)=>arr.indexOf(s) === i) // Eliminar duplicados
            .join(', ');
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: STEPS.map((step, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: `flex flex-col items-center gap-1 ${index <= currentStep ? 'text-primary-600 dark:text-primary-400' : ''}`,
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: `text-lg ${index <= currentStep ? 'opacity-100' : 'opacity-50'}`,
                                        children: step.icon
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(dashboard)/dashboard/requests/new/page.tsx",
                                        lineNumber: 381,
...
_s(NewRequestPage, "dgl6NkBhHFhUaH0Qz8uIjI1w+uc=", false, function() {
    return [
...
//# sourceMappingURL=src_202526c5._.js.map