...
;
;
// ✅ Datos de regiones y provincias (Chile)
const REGIONS = [
    {
        id: 'region-01',
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            const requestData = {
                ...
                // ✅ Guardar WhatsApp para contacto
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                onChange: (e)=>{
                                    ...
                                    const province = PROVINCES[formData.regionId]?.find((p)=>p.id === provinceId);
                                    setFormData((prev)=>({
                                            ...prev,
                                            provinceId,
                                ...
                                children: [
                                    ...
                                    (PROVINCES[formData.regionId] || []).map((province)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: province.id,
...
_s(NewRequestPage, "8unmX/QrIlXNWyr2sVcqnCmFuvM=", false, function() {
    return [
...
//# sourceMappingURL=src_eeaf3cd5._.js.map