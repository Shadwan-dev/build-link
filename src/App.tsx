...
import ClientProvider from './components/tenant/ClientProvider';
import { clientConfig } from './config/client-config'; // Importar la config
    ...
    <ClientProvider>
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
          ...
          <section
            id="home"
            className="section bg-gradient-to-br from-blue-50/30 to-emerald-50/30"
          >
            <Hero />
          </section>
        ...
        <a
          href={`https://wa.me/${clientConfig.contact.whatsapp}`} // Usar clientConfig directamente
          target="_blank"
